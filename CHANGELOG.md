...
### Added
- **InvoicesResource**: Enhanced with model object support and expand parameter
  - `create(debt_id, data, expand=None)` - Now accepts Invoice model objects directly
  - `update(debt_id, invoice_id, data, expand=None)` - Now accepts Invoice model objects directly
