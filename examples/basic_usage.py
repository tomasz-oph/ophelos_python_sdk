...
def main():
    ...
    try:
        ...
        customer_data = {
            ...
            "metadata": {"external_id": "customer_001", "source": "example_script"},
        }
        ...
        debt_data = {
            ...
            "metadata": {"case_id": "12345", "original_creditor": "Example Corp"},
        }
        ...
        for debt_item in debts.data:
            print(
                f"  - {debt_item['id']}: £{debt_item['total_amount'] / 100:.2f} ({debt_item['status']})"
            )
        ...
        payment_data = {
            ...
            "metadata": {"external_reference": "BANK-REF-123"},
        }
